...
import eve.nikr.net.client.auth.Authentication;
import eve.nikr.net.client.auth.HttpBasicAuth;
import eve.nikr.net.client.auth.ApiKeyAuth;
import eve.nikr.net.client.auth.OAuth;
import eve.nikr.net.client.auth.RetryingOAuth;
import eve.nikr.net.client.auth.OAuthFlow;

public class ApiClient {

    private String basePath = "https://vn0pw7g9id.execute-api.us-east-1.amazonaws.com/v3";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://vn0pw7g9id.execute-api.us-east-1.amazonaws.com/v3
