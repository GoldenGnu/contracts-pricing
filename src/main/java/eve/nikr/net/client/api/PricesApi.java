...
public class PricesApi {
     ...
     */
    public com.squareup.okhttp.Call getPricesCall(Integer typeId, Boolean includePrivate, Boolean bpc, List<String> security, Integer materialEfficiency, Integer timeEfficiency, final ApiCallback callback) throws ApiException {
        ...
        if (materialEfficiency != null) {
            localVarQueryParams.addAll(apiClient.parameterToPair("material_efficiency", materialEfficiency));
        }
    ...
    private com.squareup.okhttp.Call getPricesValidateBeforeCall(Integer typeId, Boolean includePrivate, Boolean bpc, List<String> security, Integer materialEfficiency, Integer timeEfficiency, final ApiCallback callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPricesCall(typeId, includePrivate, bpc, security, materialEfficiency, timeEfficiency, callback);
        return call;
    ...
    public Prices getPrices(Integer typeId, Boolean includePrivate, Boolean bpc, List<String> security, Integer materialEfficiency, Integer timeEfficiency) throws ApiException {
        ApiResponse<Prices> resp = getPricesWithHttpInfo(typeId, includePrivate, bpc, security, materialEfficiency, timeEfficiency);
        return resp.getData();
    }
    ...
    public ApiResponse<Prices> getPricesWithHttpInfo(Integer typeId, Boolean includePrivate, Boolean bpc, List<String> security, Integer materialEfficiency, Integer timeEfficiency) throws ApiException {
        com.squareup.okhttp.Call call = getPricesValidateBeforeCall(typeId, includePrivate, bpc, security, materialEfficiency, timeEfficiency, null);
     ...
     */
    public com.squareup.okhttp.Call getPricesAsync(Integer typeId, Boolean includePrivate, Boolean bpc, List<String> security, Integer materialEfficiency, Integer timeEfficiency, final ApiCallback<Prices> callback) throws ApiException {

        com.squareup.okhttp.Call call = getPricesValidateBeforeCall(typeId, includePrivate, bpc, security, materialEfficiency, timeEfficiency, callback);
        Type localVarReturnType = new TypeToken<Prices>(){}.getType();
